...
public final class DocOutFileManager {
    ...
    public static void createOutputDocumentFile(RequestDocumentContext requestDocumentContext) throws IOException{
    ...
    private static File copyDefaultFile(RequestDocumentContext requestDocumentContext) throws IOException{
        ...
        var newFile = new File(outputDocFilePathName);
